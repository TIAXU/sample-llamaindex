...
# 指定全局llm与embedding模型
Settings.llm = AzureOpenAI(engine="gpt-35-turbo", temperature=0, model="gpt-35-turbo")
Settings.embed_model = AzureOpenAIEmbedding(deployment_name="text-embedding-3-small", model="text-embedding-3-small", dimensions=512)
